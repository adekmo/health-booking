    ...
    <div className="flex min-h-screen">
      ...
      <aside className="w-64 bg-emerald-800/30 text-white p-4">
        ...
        <nav className="flex flex-col space-y-2">
          <Link href="/dashboard/nutritionist">Overview</Link>
          <Link href="/dashboard/nutritionist/bookings">My Bookings</Link>
          <Link href="/dashboard/nutritionist/calendar">Calendar</Link>
          <Link href="/dashboard/nutritionist/profile">Profile</Link>
